...
(1, 0, 'simple', 'shop', '{"en_sg":"Simple","zh_cn":"简约"}', 'Multishop', '0.00', 'SGD', NULL, 'TH;OFF;', 1480695738, 1480695738);
INSERT INTO `s_theme` (`id`, `account_id`, `theme`, `theme_group`, `name`, `designer`, `price`, `currency`, `params`, `status`, `create_time`, `update_time`) VALUES
(2, 0, 'neat', 'shop', '{"en_sg":"Neat","zh_cn":"整齐"}', 'Multishop', '0.00', 'SGD', NULL, 'TH;OFF;', 1480695738, 1480695738);
INSERT INTO `s_theme` (`id`, `account_id`, `theme`, `theme_group`, `name`, `designer`, `price`, `currency`, `params`, `status`, `create_time`, `update_time`) VALUES
(3, 0, 'light', 'shop', '{"en_sg":"Light","zh_cn":"光色"}', 'Multishop', '0.00', 'SGD', NULL, 'TH;OFF;', 1480695738, 1480695738);
