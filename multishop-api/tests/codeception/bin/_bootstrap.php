...
$appName = basename(dirname(dirname(dirname(dirname(__FILE__)))));// The app directory name, e.g. multishop-api
defined('YII_APP_ID') or define('YII_APP_ID', $appName);
require_once(dirname(__FILE__).'/../../../../multishop-kernel/config/globals.php');
...
require(dirname(__FILE__).'/../../../../multishop-kernel/components/Yii2.php');
