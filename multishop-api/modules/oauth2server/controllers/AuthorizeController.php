 ...
 * <pre>
 * //Example invocation:
 * http://api.multishop.org/oauth2/authorize?response_type=code&client_id=<client_id>&state=<state_value>&redirect_uri=<redirect_uri>
 * 
 * </pre>
 * @author kwlok
 */
class AuthorizeController  extends Controller 
{
     ...
     * http://api.multishop.org/oauth2/authorize?response_type=code&client_id=<client_id>&client_secret=<client_secret>&user_id=<user_id>&state=<state_value>&redirect_uri=<redirect_uri>
     * 
     * @return mixed
     */
