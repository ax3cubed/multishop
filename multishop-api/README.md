Multishop API - Open Source Ecommerce Platform  
=======================================
...
>
> To run console command, `multishop-console` is required. 
>

API Reference
-------------
Please refer to [API Reference Guide](/docs/multishop-api-spec.yaml).
