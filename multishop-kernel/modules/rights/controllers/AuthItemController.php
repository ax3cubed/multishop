<?php
/**
 * This class is futher customized to fit into multishop use. 
 * Look for code fragment below for customizations:
 * <pre>
 * ---- BEGIN CUSTOMIZATION ----
 * [1] Extends AuthItemController to SController
 * [2] Load common.widgets asset bundle (for consitent UI display)
 * [3] Rename method loadModel() to loadAuthItemModel() to avoid clashing with SController::loadModel()
 * ---- END CUSTOMIZATION -----
 * </pre>
 * @author kwlok
 */
 ...
 * @since 0.5
 */
class AuthItemController extends SController
{
	/**
	...
	*/
	public function init()
	{
		...
		$this->module->registerScripts();
                ...
                //---- BEGIN CUSTOMIZATION ----
                $this->registerFontAwesome();//also for the purpose of loading common.widgets asset bundel
                //---- END CUSTOMIZATION -----                
	}
	...
	*/
	public function actionPermissions()
	{
        ...
        /**
         * Comment on for now to prevent error
         * @author kwlok
         * @todo Below if comment off will hit Fatal error: Allowed memory size of 134217728 bytes exhausted (tried to allocate 64 bytes) ' as too many records returned
         * either increase php buffer/memory size? or implement pagination for the result set.
         */
...
//	}
	...
	public function actionCreate()
	{
		...
		if( isset($_POST['AuthItemForm'])===true )
		{
			...
			if( $formModel->validate()===true )
			{
				...
				//---- BEGIN BUGFIX ----
				//Bug fix: not redirecting else flash message will not be displayed
	...
	*/
	public function actionUpdate()
	{
		...
		$model = $this->loadAuthItemModel();//---- CUSTOMIZATION ----
	...
	*/
        //---- BEGIN CUSTOMIZATION ----
	public function loadAuthItemModel()
        //---- END CUSTOMIZATION -----                
	{
		if( $this->_model===null )
		{
