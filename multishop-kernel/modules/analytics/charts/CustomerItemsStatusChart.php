...
/**
 * Description of CustomerItemsStatusChart
 *
 * @author kwlok
 */
class CustomerItemsStatusChart extends StatusChart 
{
    const ID   = 'CustomerItemsStatusChart';
    const MODEL = 'Item';
    const MAIN_STATUS = Process::REVIEWED;
    /**
