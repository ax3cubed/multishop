         ...
         <tbody>
             <tr>
                 <td colspan="2" style="border-bottom:0px dashed #EDEDED;">
                     <span style="font-size:2.5em;float:right;margin:10px"><?php echo Sii::t('sii','Receipt Notice');?></span>
                     <div style="padding:5px 10px;margin:5px 10px;border: 2px dashed lightgrey;float: left;width:62%">
                         <div style="display:inline">
                            <?php echo Sii::t('sii','Customer has received this item on {datetime}',['{datetime}'=>$model->formatDatetime($model->update_time, true)]);?>
                        </div>
                     </div>
                 </td>
             </tr>
