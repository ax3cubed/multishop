         ...
         <tbody>
             <tr style="background:whitesmoke;">
                 <td colspan="2" style="border-bottom:0px dashed #EDEDED;">
                    <span style="font-size:2em;margin:10px"><?php echo Sii::t('sii','Ticket Response');?></span>
                     <div style="float:right;">
                        ...
                        <?php endif;?>
                        <div>
                            <strong><?php echo Sii::t('sii','Reply Date');?></strong>
                            <span><?php echo $model->formatDateTime($model->create_time,true);?></span>
                        </div>
                        <div>
                            <strong><?php echo Sii::t('sii','Reply By');?></strong>
                            <span>
            ...
            <tr>
                <td width="60%" style="padding-top: 10px;padding-left:20px;">
                    ...
                    <p><?php echo Sii::t('sii','Dear user,');?></p>
