         ...
         <tbody>
             <tr style="background:whitesmoke;">
                 <td colspan="2" style="border-bottom:0px dashed #EDEDED;">
                     <span style="font-size:2.5em;float:right;margin:10px"><?php echo Sii::t('sii','Unsuccessful Shop Application Notice');?></span>
                 </td>
             </tr>
            <tr>
                <td width="60%" style="padding-top: 10px;padding-left:20px;">
                    ...
                    <div style="margin-top:10px;">
                        <p><?php echo Sii::t('sii','We regret to inform you that your shop application dated {datetime} for shop {shop_name} is not successful.',array('{datetime}'=>$model->formatDatetime($model->create_time),'{shop_name}'=>$model->displayLanguageValue('name',$model->getLocale())));?></p>
                    </div>
