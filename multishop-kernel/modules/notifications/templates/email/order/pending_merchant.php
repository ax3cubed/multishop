         ...
         <tbody>
             <tr>
                 <td colspan="2" style="border-bottom:0px dashed #EDEDED;">
                     <span style="font-size:2.5em;float:right;margin:10px"><?php echo Sii::t('sii','Pending Payment Verification');?></span>
                     <div style="padding:5px 10px;margin:5px 10px;border: 2px dashed lightgrey;float: left;width:45%">
                            <?php echo Sii::t('sii','Notes:');?>
                            <ul style="padding-left:15px">
                                <li><?php echo Sii::t('sii','Customer had chosen payment method <strong>{payment_method}</strong>',['{payment_method}'=>$model->getPaymentMethodName(user()->getLocale())]);?></li>
                                <li><?php echo Sii::t('sii','Please accept or reject the payment.');?></li>
                            </ul>
                     </div>
                 </td>
             </tr>
