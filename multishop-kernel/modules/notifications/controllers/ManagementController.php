        ...
        switch (strtolower($modelType[1])) {
            case 'account':
                ...
                elseif (strtolower($modelType[2])=='welcome'){
                    ...
                    //NOT IN USED
                    //Customer welcome email is applicable only when Multishop.org is evolving into a market place (a shopping mall housing all shops in Multishop.org)
                    //And the email will be sent to Multishop.org shopping mall users
