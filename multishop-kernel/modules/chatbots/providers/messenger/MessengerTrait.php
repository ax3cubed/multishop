...
trait MessengerTrait 
{
     ...
     * $buttons = [];
     * $buttons[] = new WebUrlButton('Open Web URL','https://www.multishop.org/');
     ...
     * $bubbles[] = new Bubble('rift', 'Next-generation virtual reality', 'https://www.oculus.com/en-us/rift/', 'https://www.multishop.org/assets/fc419335/rift.png', $buttons1);
     * $buttons2 = [];
     ...
     * $bubbles[] = new Bubble('touch', 'Your Hands, Now in VR', 'https://www.oculus.com/en-us/touch/', 'https://www.multishop.org/assets/fc419335/touch.png', $buttons2);
     * </pre>
     * @param type $recipient
     * @param array $bubbles
     */
