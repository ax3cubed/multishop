...
/**
 * TrendRecentPurchasesView shows the recently purchased products
 *
 * @author kwlok
 */
class TrendRecentPurchasesView extends ShopProductsPageView
{
    /**
    ...
    public function render($payload) 
    {
        ...
        $searchResult = $this->getSearchResult($model, 'searchRecentlyPurchasedProducts', [$currentPage]);
