...
/**
 * TrendMostLikesView shows the most likes products
 *
 * @author kwlok
 */
class TrendMostLikesView extends ShopProductsPageView
{
    /**
    ...
    public function render($payload) 
    {
        ...
        $searchResult = $this->getSearchResult($model, 'searchMostLikesProducts', [$currentPage]);
