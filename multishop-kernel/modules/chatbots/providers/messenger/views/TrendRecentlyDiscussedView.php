...
/**
 * TrendRecentlyDiscussedView shows the recently discussed products
 *
 * @author kwlok
 */
class TrendRecentlyDiscussedView extends ShopProductsPageView
{
    /**
    ...
    public function render($payload) 
    {
        ...
        $searchResult = $this->getSearchResult($model, 'searchRecentlyDiscussedProducts', [$currentPage]);
