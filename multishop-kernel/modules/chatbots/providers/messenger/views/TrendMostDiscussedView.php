...
/**
 * TrendMostDiscussedView shows the most discussed products
 *
 * @author kwlok
 */
class TrendMostDiscussedView extends ShopProductsPageView
{
    /**
    ...
    public function render($payload) 
    {
        ...
        $searchResult = $this->getSearchResult($model, 'searchMostDiscussedProducts', [$currentPage]);
