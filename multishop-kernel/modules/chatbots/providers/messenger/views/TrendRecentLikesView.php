...
/**
 * TrendRecentLikesView shows the recently liked products
 *
 * @author kwlok
 */
class TrendRecentLikesView extends ShopProductsPageView
{
    /**
    ...
    public function render($payload) 
    {
        ...
        $searchResult = $this->getSearchResult($model, 'searchRecentlyLikedProducts', [$currentPage]);
