...
function loadDependencies($root,$depends,$appPath)
{
    ...
    Yii::trace('<< initial class map >> '.var_export(Yii::$classMap,true),'system.multishop');//regards this as system trace       
    Yii::trace('<< dependencies settings >> '.var_export($depends,true),'system.multishop');//regards this as system trace
}
function loadModules($depends)
{
    ...
    Yii::trace('<< modules settings >> '.var_export($modules->toArray(),true),'system.multishop');//regards this as system trace
    return $modules->toArray();
}
function importClass($alias,$forceInclude=false)
{
    Yii::import($alias,$forceInclude);
    Yii::trace('importing '.$alias,'system.multishop');//regards this as system trace
}
function setAlias($alias,$path)
{
    Yii::setPathOfAlias($alias, $path);
    Yii::trace('setAlias '.$alias.'='.alias($alias),'system.multishop');//regards this as system trace
}
...
//E.g. remove "www" if found - left with ".multishop.org"
