...
(1) `multishop-kernel` common module level messages (2) local module level messages
...
### Bug fixes:
 ...
 - Bug: Support Codeception test at `multishop-api`


## Version 0.24 - Jun 24, 2017

This is the initial release of `multishop-kernel`, part of Multishop.org open source project. 
