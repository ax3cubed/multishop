...
class SUrlManager extends CUrlManager
{
    ...
    /**
     * @property string the host domain of web app. e.g. www.multishop.org
     */
    public $hostDomain;
    /**
     * @property string the cdn domain. e.g. cdn.multishop.org
     */
    public $cdnDomain;
    /**
     * @property string the merchant portal domain. e.g. merchant.multishop.org
     */
    public $merchantDomain;
    /**
     * @property string the shop storefront domain. e.g. www.multishop.org
     */
    public $shopDomain;
    /**
     * @property string the bot app domain. e.g. bot.multishop.org
     */
    public $botDomain;
    /**
