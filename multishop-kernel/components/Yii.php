...
/**
 * This file contains script to make both Yii 1.x and Yii 2.x run together;
 * //----------------
 * //NOTE1: copy Yii 1.x YiiBase.php code here
 * //----------------/
 * //NOTE2: Replace following function
 * //----------------/
 * ```php
 * public static function getVersion()
 * {
 *     return YiiBase::getVersion();
 * }
 * ```
 * //----------------/
 * //NOTE3: Add following function
 * //----------------/
 * ```php
 * public static function getYii2Version()
 * {
 *     return \yii\BaseYii::getVersion();
 * }
 * ```
 *
 * Usage:
 * To access Yii 1.x, use Yii::app()
 * To access Yii 2.x, use Yii::$app
 * 
 * E.g. 
 * echo "<br>".get_class(Yii::app()); // outputs 'CWebApplication'
 * echo "<br>".get_class(Yii::$app);  // outputs 'yii\web\Application'
 * 
 * @author kwlok
 */
...
{
    //----------------
    //copy Yii 1.x YiiBase.php code here
    //----------------/
	/**
	...
	/**
	 * @return string the version of Yii2 framework
	 */
	public static function getYii2Version()
	{
		return \yii\BaseYii::getVersion();
...
Yii::$classMap = include(YII2_FRAMEWORK_PATH . '/classes.php');
...
//---------------
//NOTE: DO NOT start yii2engine here as it will break some of the codes using Yii 1.1
//Call bootstrapYii2Engine() at global.php instead on demand basis
//---------------//
