...
{     
    use WcmContentTrait, WcmLayoutTrait, SubscriptionControllerTrait;
    ...
    public function accessRules()
    {
        return array_merge([
            ['allow',  
                'actions'=>['index','features','pricing'],
                'users'=>['*'],
            ]
    ...
    /**
     * This shows merchant portal "pricing plan".
     */
    public function actionPricing()
    {
        $seoTitle = $this->getPageSeo('pricing', 'seoTitle');
        $this->pageTitle = strlen($seoTitle) > 0 ? $seoTitle: Sii::t('sii','Pricing'); 
        $this->metaDescription = $this->getPageSeo('pricing', 'seoDesc');
        $this->metaKeywords = $this->getPageSeo('pricing', 'seoKeywords');
        $this->render('pricing');
    }     
    /**
     * This shows the dynamic package pricing
     */
    public function renderPackages()
    {
        $this->registerCssFile('plans.assets.css','plans.css');
        $this->renderPartial('plans.views.subscription.index');
    }
    /**
    ...
    {
        $this->renderPartial('_callout',['callout'=>$config]);
    }
    /**
     * Render faq
     */
    ...
    {
        echo $this->renderMarkdown('faq',['SITE_NAME','TRIAL_DURATION'=>$this->getFreeTrialDuration()]);
    }
    /**
    ...
    public function getContentParams()
    {
        return [
            ...
            'THEME_STORE_URL'=>hostUrl('themes'),
        ];
    }    
    /**
...
//        Helper::registerJs($script);
    ...
    {
        return Plan::freeTrialInstance()!=null ? Plan::freeTrialInstance()->duration : '[?]';
    }
}
