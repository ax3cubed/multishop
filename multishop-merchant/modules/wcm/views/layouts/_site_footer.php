<div class="upper_footer">
    <ul>
        ...
        <li><?php echo l(Sii::t('sii','Theme Store'), hostUrl('themes'));?></li>
        <li><?php echo l(Sii::t('sii','Chatbot'), hostUrl('features/chatbots#all'));?></li>
    </ul>
    <ul>
        <h3><?php echo Sii::t('sii','Community');?></h3>
        <li><?php echo l(Sii::t('sii','Tutorials'), communityUrl('tutorials'));?></li>
        <li><?php echo l(Sii::t('sii','Tutorial Series'), communityUrl('tutorials/series'));?></li>
        <li><?php echo l(Sii::t('sii','Questions'), communityUrl('questions'));?></li>
    </ul>
...
<div class="lower_footer">
    <ul class="copyright">
        <li><?php echo Sii::t('sii','Copyright &copy; 2015 - {year} {company}',['{year}'=>date('Y'),'{company}'=>CHtml::link(param('ORG_NAME'),hostUrl('about'))]);?></li>
<!--        <li><?php //echo l(Sii::t('sii','About us'), hostUrl('about'));?></li>-->
        <li><?php echo l(Sii::t('sii','Terms of Service'), hostUrl('terms'));?></li>
        <li><?php echo l(Sii::t('sii','Privacy Policy'), hostUrl('privacy'));?></li>
        <li><?php echo l(Sii::t('sii','Contact us'), hostUrl('contact'));?></li>
    </ul>
</div>