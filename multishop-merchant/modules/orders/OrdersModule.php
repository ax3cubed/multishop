...
class OrdersModule extends SModule 
{
    ...
    public function init()
    {
        ...
        $this->setDependencies([
            ...
            'views'=>[
                'merchantorderlist'=>'application.modules.orders.views.merchant._shippingorder_listview',
                'merchanttotal'=>'application.modules.orders.views.merchant._total',
                'merchantinventory'=>'application.modules.orders.views.merchant._inventories',
                //common views
        ...
        //Registered required asset bundles for orders module
        $this->registerScripts();
        $this->registerGridViewCssFile();
        $this->registerFormCssFile();
        $this->registerTaskScript(true);//including css
