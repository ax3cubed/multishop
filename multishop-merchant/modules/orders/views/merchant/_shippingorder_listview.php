            ...
            'value'=>$this->widget('common.widgets.SDetailView', array(
                ...
                'attributes'=>array(
                    array(
                        ...
                        'value'=>CHtml::link(CHtml::encode($data->shipping_no), $data->viewUrl),
                    ),
                    array(
                        'type'=>'raw',
                    ...
                    array(
                        'type'=>'raw',
                        'template'=>'<div class="element">{value}</div>',
                        'value'=>'<strong>'.CHtml::encode($data->getAttributeLabel('order_id')).'</strong>'.
                                 CHtml::link($data->order_no,$data->getPOViewUrl()),
                    ),        
                    array(
                        'type'=>'raw',
                        'template'=>'<div class="element">{value}</div>',
