...
{% if (o.files[0].import_preview) /*one import file assumed*/
       previewproductimport(o.files[0].import_preview);
%}
{% for (var i=0, file; file=o.files[i]; i++) { %}
    ...
    <tr class="template-download fade {%=row%}">
        ...
        {% } else { %}
            ...
            <td width="30%" class="preview"><span>{%=o.formatFileSize(file.size)%}</span></td>
