<?php cs()->registerScript('renderform','rendercampaignsaleform();',CClientScript::POS_END);?>
...
<div class="data-form">
    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <div class="row">
            ...
            <div>
                <?php echo $form->textField($model,'sale_value',array('size'=>1,'maxlength'=>10,'style'=>'width:30px;display:inline-block')); ?>
                <?php echo $form->dropDownList($model,'sale_type',CampaignSale::model()->getSaleTypes(), 
                                                array('class'=>'chzn-select-sale',
                                                  'prompt'=>'',
                                                  'data-placeholder'=>$model->getAttributeLabel('sale_type'),
                                                 )); ?>
        ...
        <div class="row">
            ...
            <div>
                ...
                <?php echo $form->dropDownList($model,'offer_type',CampaignSale::model()->getOfferTypes(), 
