<?php $this->widget($this->getModule()->getClass('gridview'), array(
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'zone_id',
            'value'=>'$data->zone->displayLanguageValue(\'name\',user()->getLocale())',
            'filter'=>CHtml::listData(Zone::model()->mine()->findAll(),'id','name'),
            'htmlOptions'=>array('style'=>'text-align:center;'),
            'type'=>'html',
        ),
        array(
        ...
        array(
            'class'=>'SButtonColumn',
            'buttons'=>SButtonColumn::getShippingButtons(array(
                'view'=>true,
