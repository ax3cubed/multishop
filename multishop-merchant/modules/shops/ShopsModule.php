...
class ShopsModule extends SModule 
{
    ...
    public function init()
    {
        ...
        $this->setImport([
            'shops.models.*',
            'common.modules.shops.models.JsonSettingsForm',
        ...
        $this->setDependencies([
            ...
            'views'=>[
                'sidebar'=>'application.modules.shops.views.management._sidebar',
                'shopapply'=>'application.modules.shops.views.management.apply',
                'shopapplyform'=>'application.modules.shops.views.management._form_apply',
                'shopsettingform'=>'application.modules.shops.views.management._form_setting',
                'shopcontactform'=>'application.modules.shops.views.management._form_contact',
                'shoplocaleform'=>'application.modules.shops.views.management._form_locale',
                'shopaddressform'=>'application.modules.shops.views.management._form_address',
                //common views
