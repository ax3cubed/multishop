# Change Log (multishop-chatbot)

## Version 0.25 - Aug 5, 2018

This release is a minor patch but version is promoted to v0.25 to keep in line with other `multishop-app` releases using v0.25 also.

### Enhancements:

 - Chg: The Sii messages at app level will be standalone and not merged with multishop-kernel common messages.
...
This is the initial release of `multishop-chatbot`, part of Multishop.org open source project. 
